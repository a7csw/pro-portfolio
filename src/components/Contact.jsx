    ...
    <section id="contact" ref={ref} className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            <div className="grid md:grid-cols-3 gap-8 mb-8">
              <div>
                ...
                <div className="text-sm text-gray-400">I'll get back to you within 24 hours</div>
              </div>
              <div>
                <div className="text-3xl mb-3">💬</div>
                <div className="font-semibold mb-2">Free Consultation</div>
                <div className="text-sm text-gray-400">Let's discuss your project with no commitment</div>
              </div>
              <div>
                <div className="text-3xl mb-3">🎯</div>
                <div className="font-semibold mb-2">Clear Pricing</div>
                <div className="text-sm text-gray-400">Transparent quotes tailored to your needs</div>
              </div>
            </div>
          ...
          >
            <div className="text-gray-400">Or connect with me</div>
            <div className="flex items-center gap-6">
              <a
                href="https://github.com/a7csw"
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 flex items-center justify-center bg-white/5 border border-white/10 rounded-full hover:border-white/20 hover:bg-white/10 transition-all duration-300"
              >
              ...
              <a
                href="https://www.linkedin.com/in/abdulrahman-alfaiadi-93577b2a3/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 flex items-center justify-center bg-white/5 border border-white/10 rounded-full hover:border-white/20 hover:bg-white/10 transition-all duration-300"
              >
              ...
              <a
                href="https://www.instagram.com/a7csw?igsh=dGljYTRtYmpxeWt2&utm_source=qr"
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 flex items-center justify-center bg-white/5 border border-white/10 rounded-full hover:border-white/20 hover:bg-white/10 transition-all duration-300"
              >
      ...
      <motion.footer
        ...
        className="mt-24 border-t border-white/10 pt-8 text-center text-sm text-gray-500"
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <p>© {new Date().getFullYear()} Abdurrahman</p>
        </div>
      </motion.footer>
    </section>
  )
